...
2. Research the audience and map competitors before writing anything (WebSearch/WebFetch when the brief is thin). Never assume you know the audience's language.
...
- Lock the tone profile before writing; when voice consistency across multiple outputs matters, write the tone profile down first and reuse it.
