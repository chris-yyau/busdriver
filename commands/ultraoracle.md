---
description: Run a single repo-grounded UltraOracle (GPT-5.5 Pro) expert-witness consult — quick/repo/upstream-audit modes with review-type labeling and fail-closed handling.
---
...
secret-free evidence pack (`repo`/`upstream-audit` modes), dispatches to GPT-5.5 Pro,
