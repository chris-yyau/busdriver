...
```bash
ACKS="cursor=none,cubic-dev-ai=none,coderabbitai=none,devin-ai-integration=none"
ACK_TIERS="cursor=none,cubic-dev-ai=none,coderabbitai=none,devin-ai-integration=none"
CODEX_ACK=none                                              # Codex Tier-F ack; `none` = non-gating default
BOT_LEDGER="cursor=0/0:none,cubic-dev-ai=0/0:none,coderabbitai=0/0:none,devin-ai-integration=0/0:none,codescene-delta-analysis=0/0:none,chatgpt-codex-connector=0/0:none"
...
post-push fetch — see `opencode/skills/pr-grind/SKILL.md` dispatcher commit block. The
...
# opencode/skills/pr-grind/SKILL.md (Step 6.5 inline block, Completion re-query
...
ACKS="cursor=$(_ackpart "$_cur"),cubic-dev-ai=$(_ackpart "$_cub"),coderabbitai=$(_ackpart "$_cod"),devin-ai-integration=$(_ackpart "$_dev")"
ACK_TIERS="cursor=$(_tierpart "$_cur"),cubic-dev-ai=$(_tierpart "$_cub"),coderabbitai=$(_tierpart "$_cod"),devin-ai-integration=$(_tierpart "$_dev")"
...
# contract for the four SHA-keyed structured bots; Codex's clean signal is a
...
| Writing `.opencode/pr-grind-clean.local` | Dispatcher writes the marker after verifying state. |
...
WORKTREE_DIR=/Volumes/Work/Projects/busdriver/.opencode/worktrees/pr-grind-64
ROUND=3 (fix=2/5, wait=0/8)
PRIOR_COMMIT_SHA=8947cdd
PRIOR_REVIEWER_ACKS=cursor=stale,cubic-dev-ai=stale,coderabbitai=stale,devin-ai-integration=stale
PRIOR_ATTEMPTS:
  - Round 1 (fix=1/5, wait=0/8): fixes=mkdir -p ordering in run-review-loop.sh; failures=none; acks=cursor=stale,cubic-dev-ai=none,coderabbitai=stale,devin-ai-integration=none
  - Round 2 (fix=2/5, wait=0/8): fixes=tilde expansion in target_dir parser; failures=none; acks=cursor=stale,cubic-dev-ai=stale,coderabbitai=stale,devin-ai-integration=stale
```
...
RESULT_BOT_LEDGER: cursor=0/1:approved,cubic-dev-ai=1/1:fixed SC2015 short-circuit,coderabbitai=0/0:none,devin-ai-integration=0/0:none,codescene-delta-analysis=0/0:none,chatgpt-codex-connector=0/0:none
