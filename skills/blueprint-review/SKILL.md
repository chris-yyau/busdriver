...
tier — Claude Fable; see ADR 0011 as amended by ADR 0014). The **primary** ultimate path is a
...
tool now selects `model="fable"` (→ `claude-fable-5`) directly (ADR 0014), so a fable subagent —
