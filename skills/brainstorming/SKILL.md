...
**Latency:** a ChatGPT Pro consult runs minutes (oracle default HTTP timeout 20m, Pro auto-timeout ~60m). This is a deliberate BLOCKING wait; the adapter surfaces oracle's `--heartbeat` progress on the terminal.
