...
3. **Offer the visual companion just-in-time — NOT upfront.** The first time a clarifying question (Step 2) would genuinely be clearer shown than described, offer it then (its own message, not combined with a question). If no visual question ever arises, never offer it. See the Visual Companion section below.
