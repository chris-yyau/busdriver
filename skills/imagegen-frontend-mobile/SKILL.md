...
> **Transport:** this skill is art direction only — it assumes a host with an image tool. In Claude Code there isn't one; dispatch each image through `busdriver:imagegen`.
