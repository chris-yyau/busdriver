...
4. Parse the agent's JSON output for blocking issues: any issue whose severity is not exactly `low` blocks (compare case-insensitively). Unrecognized or out-of-enum severities count as blocking.
