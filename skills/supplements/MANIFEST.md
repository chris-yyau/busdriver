...
|------|---------|---------|--------|-------|
| `design-anti-slop.md` | `document-skills:frontend-design`, `busdriver:frontend-patterns`, `ui-ux-pro-max` | "avoid AI slop", "make it unique" | gstack /design-consultation | 2026-03-24 |
