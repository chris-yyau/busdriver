...
# Secret-scan + repo-containment gates are single-sourced in lib/evidence-safety.sh
# (ADR 0007 Phase 5 Task 1) so this builder and retrieve-evidence.sh share one audited
# copy. GIT_ROOT (canonicalized above) is the required global the gates compare against.
