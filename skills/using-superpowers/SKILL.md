...
- "Let's build X" → `busdriver:brainstorming` first, then implementation skills.
- "Fix this bug" → `busdriver:systematic-debugging` first, then domain skills.
...
- Antigravity (agy): `references/agy-tools.md`
